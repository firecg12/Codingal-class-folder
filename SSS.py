# cant test code cause of no model but this is the code for face and emotion detection using a pre-trained model and Haar Cascade Classifier. Make sure to replace 'example_model.h5' with the path to your actual pre-trained emotion recognition model. and my pip install commands dont work so i cant install the required libraries but this is the code for it.
import cv2
...
emotion_model = load_model('example_model.h5')  # Replace with an existing model path
